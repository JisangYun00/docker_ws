...
│   ├── catkin_ws/          # ROS 패키지 빌드 공간 (컨테이너 내부: /catkin_ws)
...
mkdir -p ~/docker_ws/ubuntu20_ros1/catkin_ws
mkdir -p ~/docker_ws/ubuntu24/colcon_ws
...
services:
  ros1:
    ...
    volumes:
      ...
      - /home/jisang/docker_ws/ubuntu20_ros1/catkin_ws:/catkin_ws  # ROS 빌드 공간
...
~/docker_ws/git/                    →   /git/
~/docker_ws/ubuntu20_ros1/catkin_ws →   /catkin_ws/
...
source /catkin_ws/devel/setup.bash  # 빌드된 경우에만

alias cb='cd /catkin_ws && catkin_make'   # 빌드
alias cs='source /catkin_ws/devel/setup.bash'  # source
alias ccd='cd /catkin_ws'                # catkin_ws로 이동
```
